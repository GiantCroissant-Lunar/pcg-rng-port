...
internal struct Pcg32C64FastEngine : IEquatable<Pcg32C64FastEngine>
{
    private Pcg32FastEngineCore _base;
    private readonly uint[] _data;

    // pcg32_c64_fast = ext_mcg_xsh_rs_64_32<6,32,false>
    private const int TablePow2 = 6;
    private const int AdvancePow2 = 32;

    public Pcg32C64FastEngine(ulong seed)
    {
    ...
    {
        // The C++ pcg32_c64_fast extended generator does not define an
        // analytic backstep/advance for the extended state. Exposing a
        // "best effort" implementation here would be misleading, so we
        // fail fast instead.
        throw new NotSupportedException("Backstep is not supported for Pcg32C64Fast (pcg32_c64_fast).");
    }
    ...
    public bool Equals(Pcg32C64FastEngine other)
    {
    ...
    {
        return obj is Pcg32C64FastEngine other && Equals(other);
    }
