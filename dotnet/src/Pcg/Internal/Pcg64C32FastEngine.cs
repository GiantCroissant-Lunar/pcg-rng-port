...
internal struct Pcg64C32FastEngine : IEquatable<Pcg64C32FastEngine>
{
    ...
    public Pcg64C32FastEngine(ulong seed)
    {
        _state = default;
    ...
    public bool Equals(Pcg64C32FastEngine other)
    {
    ...
    {
        return obj is Pcg64C32FastEngine other && Equals(other);
    }
