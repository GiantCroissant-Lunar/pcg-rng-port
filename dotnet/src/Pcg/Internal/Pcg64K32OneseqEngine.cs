...
internal struct Pcg64K32OneseqEngine : IEquatable<Pcg64K32OneseqEngine>
{
    ...
    public Pcg64K32OneseqEngine(ulong seed)
    {
        _state = default;
    ...
    public bool Equals(Pcg64K32OneseqEngine other)
    {
    ...
    {
        return obj is Pcg64K32OneseqEngine other && Equals(other);
    }
